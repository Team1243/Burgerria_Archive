...
public class AudioPlayer : MonoBehaviour
{
    ...
    public void PlayerClipWithRandomVariablePitch(string _name)
    {
    ...
    public void PlayerClipWithVariablePitch(string _name, float _pitch)
    {
    ...
    public void RandomPlay(bool VariavblePitch)
    {
        ...
        if (VariavblePitch)
            PlayerClipWithRandomVariablePitch(_clips[rand].name.ToString());
        else
